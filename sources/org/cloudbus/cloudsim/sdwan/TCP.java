...
public class TCP extends NetworkMeasurement{
	private double tranHeaderSize = 20; // transport header size =  20
	
	private double netHeaderSize = 20 ; // network header size  = 20
	private double dlHeaderSize = 26; // data link header size   = 26
