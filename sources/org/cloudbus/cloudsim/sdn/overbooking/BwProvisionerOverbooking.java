...
public class BwProvisionerOverbooking extends BwProvisioner {
	...
	public static double getOverbookedBw(double d) {
		double overbookedBw = d * BwProvisionerOverbooking.overbookingRatioBw;
		return overbookedBw;		
	}

	@Override
	public boolean allocateBwForVm(Vm vm, double d) {
		// TODO Auto-generated method stub
		return false;
	}

	@Override
	public boolean isSuitableForVm(Vm vm, double d) {
		// TODO Auto-generated method stub
		return false;
	}
