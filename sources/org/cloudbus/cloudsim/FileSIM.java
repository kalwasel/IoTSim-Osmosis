...
public class FileSIM {
	 ...
	 *             </ul>
	 */
	public FileSIM(String fileName, int fileSize) throws ParameterException {
	 ...
	 */
	public FileSIM(FileSIM file) throws ParameterException {
		if (file == null) {
	 ...
	 */
	public FileSIM makeMasterCopy() {
		FileSIM file = makeCopy();
		if (file != null) {
	 ...
	 * @return a clone of this file (as a replica) or <tt>null</tt> if an error occurs
	 */
	private FileSIM makeCopy() {
		FileSIM file = null;
		try {
			file = new FileSIM(name, attribute.getFileSize());
			FileAttribute fileAttr = file.getFileAttribute();
			attribute.copyValue(fileAttr);
			fileAttr.setMasterCopy(false);   // set this file to replica
		} catch (Exception e) {
	 ...
	 * @return <tt>true</tt> if successful, <tt>false</tt> otherwise
	 * @see gridsim.datagrid.storage.Storage#addFile(FileSIM)
	 * @see gridsim.datagrid.storage.Storage#addFile(List)
	 * @see gridsim.datagrid.storage.Storage#addReservedFile(FileSIM)
	 * @see gridsim.datagrid.storage.Storage#deleteFile(FileSIM)
	 * @see gridsim.datagrid.storage.Storage#deleteFile(String)
	 * @see gridsim.datagrid.storage.Storage#deleteFile(String, FileSIM)
	 * @see gridsim.datagrid.storage.Storage#getFile(String)
	 * @see gridsim.datagrid.storage.Storage#renameFile(FileSIM, String)
	 */
