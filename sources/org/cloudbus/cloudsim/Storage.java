...
public interface Storage {
	 ...
	 */
	double addReservedFile(FileSIM file);
	 ...
	 * file can also be found using {@link gridsim.datagrid.FileSIM#getTransactionTime()}.
	 * 
	 * @param fileName the name of the needed file
	 * @return the file with the specified filename
	 */
	FileSIM getFile(String fileName);
	 ...
	 */
	double addFile(List<FileSIM> list);

	/**
	 * Removes a file from the storage. The time taken (in seconds) for deleting the specified file
	 * can be found using {@link gridsim.datagrid.FileSIM#getTransactionTime()}.
	 * 
	 * @param fileName the name of the file to be removed
	 * @return the deleted file.
	 */
	FileSIM deleteFile(String fileName);

	/**
	 * Removes a file from the storage. The time taken (in seconds) for deleting the specified file
	 * can also be found using {@link gridsim.datagrid.FileSIM#getTransactionTime()}.
	 * 
	 * @param fileName the name of the file to be removed
	 ...
	 */
	double deleteFile(String fileName, FileSIM file);
	 ...
	 * @return the time taken (in seconds) for deleting the specified file
	 */
	double deleteFile(FileSIM file);
	 ...
	 */
	boolean renameFile(FileSIM file, String newName);
